...
public class Glossary extends AppCompatActivity {
    ...
    private void prepareGlossaryData() {
        GlossaryTerm term = new GlossaryTerm("Family Planning", "Action & Adventure", "2015");
        glossaryList.add(term);

        GlossaryTerm term2 = new GlossaryTerm("Healthy Diet", "Animation, Kids & Family", "2015");
        glossaryList.add(term2);

        GlossaryTerm term3 = new GlossaryTerm("Healthy Relationships", "Action", "2015");
        glossaryList.add(term3);

        GlossaryTerm term4 = new GlossaryTerm("Domestic Violence and Sexual Assault", "Animation", "2015");
        glossaryList.add(term4);

        GlossaryTerm term5 = new GlossaryTerm("Next Steps", "Science Fiction & Fantasy", "2015");
        glossaryList.add(term5);

        GlossaryTerm term6 = new GlossaryTerm("Alcohol and Substance Abuse During Pregnancy", "Action", "2015");
        glossaryList.add(term6);

        GlossaryTerm term7 = new GlossaryTerm("Mental Health Issues During and After Pregnancy", "Animation", "2009");
        glossaryList.add(term7);

        GlossaryTerm term8 = new GlossaryTerm("Medications and Supplements Considered Safe During Pregnancy", "Science Fiction", "2009");
        glossaryList.add(term8);

        GlossaryTerm term9 = new GlossaryTerm("Fetal Development", "Animation", "2014");
